...
function ShipDesigner(props) {
  ...
  const getAttributeHandler = (attribute, min, max) => {
    return (value) => {
       ...
       <Form.Group as={Col}>
        ...
        <Row className="mb-3">
          ...
          <Form.Group className="col-md-2 col-sm-6 col-12" as={Col}>
            ...
            <Form.Control type="number" min="1" max="6" value={currentShip.driveCount} onChange={e => getAttributeHandler('driveCount', 1, 6)(e.target.value)} showalien={showAlien ? 1 : 0}/>
          </Form.Group>
          <Form.Group className="col-md-2 col-sm-6 col-12" as={Col}>
            <Form.Label>Propellant</Form.Label>
            <Form.Control type="number" min="0" value={currentShip.propellantCount} onChange={e => getAttributeHandler('propellantCount', 0)(e.target.value)} showalien={showAlien ? 1 : 0}/>
          </Form.Group>
          <Row>
        ...
        <Form.Group className="row">
          ...
          <Form.Control type="number" min="0" value={currentShip.frontArmorCount} onChange={e => getAttributeHandler('frontArmorCount', 0)(e.target.value)}/>
          </Col>
        </Form.Group>
        <Form.Group className="row">
          ...
          <Col className="col-md-2 col-4">
          <Form.Control type="number" min="0" value={currentShip.sideArmorCount} onChange={e => getAttributeHandler('sideArmorCount', 0)(e.target.value)}/>
          </Col>
        </Form.Group>
        <Form.Group className="row">
          ...
          <Col className="col-md-2 col-4">
          <Form.Control type="number" min="0" value={currentShip.tailArmorCount} onChange={e => getAttributeHandler('tailArmorCount', 0)(e.target.value)}/>
          </Col>
        </Form.Group>
      </Form>
    </div>
